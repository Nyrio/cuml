...
const std::vector<CSRInputs<double>> inputsd = {
  ...
  {SpMM_op, 15, 13, 19, 15, 19, 25, 1.0, 0.0, 1e-6},
  {SpMM_op, 17, 15, 70, 20, 70, 85, 0.5, 0.5, 1e-6},
  {SpMM_op, 31, 10, 101, 33, 101, 63, -1.0, -1.0, 1e-6}};
...
const std::vector<CSRInputs<float>> inputsf = {
  ...
  {SpMM_op, 15, 13, 19, 15, 19, 25, 1.0f, 0.0f, 1e-2},
  {SpMM_op, 17, 15, 70, 20, 70, 85, 0.5f, 0.5f, 1e-2},
  {SpMM_op, 31, 10, 101, 33, 101, 63, -1.0f, -1.0f, 1e-2}};
